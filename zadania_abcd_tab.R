...
zadania_abcd_jedn <- tabPanel("Pytania testowe",
                              ...
                              sidebarLayout(
                                ...
                                sidebarPanel(
                                  ...
                                  selectInput("typ_zad_zam_jedn",
                                              ...
                                              c("Wybierz pietro systemu"="pie_sys",
                                                "Wybierz system eratemu"="sys_era",
                                                "Wybierz oddzial systemu"="oddz_sys",
                                                "Wybierz pietro oddzialu"="pie_oddz")),
                                  ...
                                  sidebarPanel(
                                    ...
                                    fluidRow(
                                      ...
                                      column(4,
                                             ...
                                             actionButton("check_quiz1_id", "Potwierdz",
                                      ...
                                      column(4,actionButton("check_answer", "Pokaz odpowiedz",
                                      ...
                                      column(4, actionButton("next_question_test1", "Nastepne pytanie",
