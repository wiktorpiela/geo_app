             ...
             tabPanel(icon("home"),
                      ...
                      fluidRow(
                        ...
                        column(4, align = "right",
                               ...
                               actionButton("goto_quiz1", "Pytania zamkniete",
                                               style = "height: 150px;
                                               width: 300px;
                                               border-radius: 30px;
                                               text-align: center;
                      ...
                      tags$footer(
                        ...
                        wellPanel(
                          ...
                          HTML("<h4><b>Darmowa aplikacja do nauki tabeli stratygraficznej dla studentow i pasjonatow geologii.<br> Nie zawiera polskich znakow.<br><br></b>"),
                          
                          HTML(paste(icon("photo"),"Pogranicze Pieninskiego Pasa Skalkowego i plaszczowiny magurskiej")),
