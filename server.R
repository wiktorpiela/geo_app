...
# zadania zamkniete cz 1 -------------------------------------------------------
  ...
  output$klocki_tab<- renderUI({
    ...
    if(input$typ_pyt_zam=="pie_sys"){
      ...
      rank_list(
        text = paste("Uszereguj pietra systemu:",zamk_los_klucz()),
        labels = klocki(),
      ...
      rank_list(
        text = paste("Uszereguj oddzialy systemu:",zamk_los_klucz()),
        labels = klocki(),
        input_id = "rank_list_basic"
      )
      ...
      rank_list(
        text = paste("Uszereguj pietra oddzialu:",zamk_los_klucz()),
        labels = klocki(),
        input_id = "rank_list_basic"
      )
...
# zadania zamkniete cz 2 --------------------------------------------------
  ...
  output$bucket_list <- renderUI({
    ...
    bucket_list(
        ...
        add_rank_list(
          text = "Uszereguj chronologicznie oddzialy",
          labels = NULL,
          input_id = "oddzialy"),

        add_rank_list(
          text = "Uszereguj chronologicznie pietra",
          labels = NULL,
          input_id = "pietra")
        )
      })
