...
type1 <- type1 %>% 
  mutate(pytanie = rep("Wybierz piętro systemu:",nrow(type1)), .before=SYSTEM) %>% 
  rename(true_ = "PIETRO") 
...
for(x in 1:nrow(type1)){
  ...
  switch(
    ...
    "czwartorzęd" = random_answers[[x]] <- sample(append(sample(pula[!pula%in%unique(pull(filter(type1, SYSTEM=="czwartorzęd"),true_))],4),
                                                         sample(pula[pula%in%unique(pull(filter(type1, SYSTEM=="czwartorzęd"),true_))],1))),
...
for(row in 1:nrow(type1_ready)){
  ...
  for(col in 3:ncol(type1_ready)){
    ...
    if(pull(type1_ready[row,2])=="czwartorzęd" & pull(type1_ready[row,col])%in%unique(pull(filter(type1, SYSTEM=="czwartorzęd"),true_))==TRUE) index_poprawny <- append(index_poprawny,col)
...
type3 <- type3 %>% 
  mutate(pytanie = rep("Wybierz oddział systemu:",nrow(type3)), .before=SYSTEM) %>% 
...
for(x in 1:nrow(type3)){
  ...
  switch(
    ...
    "czwartorzęd" = random_answers3[[x]] <- sample(append(sample(pula3[!pula3%in%unique(pull(filter(type3,SYSTEM=="czwartorzęd"),true_))],4),
                                                       sample(pula3[pula3%in%unique(pull(filter(type3,SYSTEM=="czwartorzęd"),true_))],1))),
...
for(row in 1:nrow(type3_ready)){
  ...
  for(col in 3:ncol(type3_ready)){
    ...
    if(pull(type3_ready[row,2])=="czwartorzęd" & pull(type3_ready[row,col])%in%unique(pull(filter(type3, SYSTEM=="czwartorzęd"),true_))) index_poprawny <- append(index_poprawny, col)
...
type4 <- type4 %>% 
  mutate(pytanie = rep("Wybierz piętro oddziału:",nrow(type4)), .before=ODDZIAL) %>% 
  rename(true_ = "PIETRO") %>% 
...
for(x in 1:nrow(type4)){
  ...
  switch(
    ...
    "kreda górna" = random_answers4[[x]] <- sample(append(sample(pula4[!pula4%in%unique(pull(filter(type4,ODDZIAL=="kreda górna"),true_))],4),sample(pula4[pula4%in%unique(pull(filter(type4,ODDZIAL=="kreda górna"),true_))],1))),
    ...
    "jura górna" = random_answers4[[x]] <- sample(append(sample(pula4[!pula4%in%unique(pull(filter(type4,ODDZIAL=="jura górna"),true_))],4),sample(pula4[pula4%in%unique(pull(filter(type4,ODDZIAL=="jura górna"),true_))],1))),
    
    "jura środkowa" = random_answers4[[x]] <- sample(append(sample(pula4[!pula4%in%unique(pull(filter(type4,ODDZIAL=="jura środkowa"),true_))],4),sample(pula4[pula4%in%unique(pull(filter(type4,ODDZIAL=="jura środkowa"),true_))],1))),
    ...
    "trias górny" = random_answers4[[x]] <- sample(append(sample(pula4[!pula4%in%unique(pull(filter(type4,ODDZIAL=="trias górny"),true_))],4),sample(pula4[pula4%in%unique(pull(filter(type4,ODDZIAL=="trias górny"),true_))],1))),
    
    "trias środkowy" = random_answers4[[x]] <- sample(append(sample(pula4[!pula4%in%unique(pull(filter(type4,ODDZIAL=="trias środkowy"),true_))],4),sample(pula4[pula4%in%unique(pull(filter(type4,ODDZIAL=="trias środkowy"),true_))],1))),
    ...
    "dewon górny" = random_answers4[[x]] <- sample(append(sample(pula4[!pula4%in%unique(pull(filter(type4,ODDZIAL=="dewon górny"),true_))],4),sample(pula4[pula4%in%unique(pull(filter(type4,ODDZIAL=="dewon górny"),true_))],1))),
    
    "dewon środkowy" = random_answers4[[x]] <- sample(append(sample(pula4[!pula4%in%unique(pull(filter(type4,ODDZIAL=="dewon środkowy"),true_))],4),sample(pula4[pula4%in%unique(pull(filter(type4,ODDZIAL=="dewon środkowy"),true_))],1))),
    ...
    "ordowik górny" = random_answers4[[x]] <- sample(append(sample(pula4[!pula4%in%unique(pull(filter(type4,ODDZIAL=="ordowik górny"),true_))],4),sample(pula4[pula4%in%unique(pull(filter(type4,ODDZIAL=="ordowik górny"),true_))],1))),
    
    "ordowik środkowy" = random_answers4[[x]] <- sample(append(sample(pula4[!pula4%in%unique(pull(filter(type4,ODDZIAL=="ordowik środkowy"),true_))],4),sample(pula4[pula4%in%unique(pull(filter(type4,ODDZIAL=="ordowik środkowy"),true_))],1))),
...
for(row in 1:nrow(type4_ready)){
  ...
  for(col in 3:ncol(type4_ready)){
    ...
    if(pull(type4_ready[row,2])=="kreda górna" & pull(type4_ready[row,col])%in%unique(pull(filter(type4, ODDZIAL=="kreda górna"),true_))) index_poprawny <- append(index_poprawny, col)
    ...
    if(pull(type4_ready[row,2])=="jura górna" & pull(type4_ready[row,col])%in%unique(pull(filter(type4, ODDZIAL=="jura górna"),true_))) index_poprawny <- append(index_poprawny, col)
    
    if(pull(type4_ready[row,2])=="jura środkowa" & pull(type4_ready[row,col])%in%unique(pull(filter(type4, ODDZIAL=="jura środkowa"),true_))) index_poprawny <- append(index_poprawny, col)
    ...
    if(pull(type4_ready[row,2])=="trias górny" & pull(type4_ready[row,col])%in%unique(pull(filter(type4, ODDZIAL=="trias górny"),true_))) index_poprawny <- append(index_poprawny, col)
    
    if(pull(type4_ready[row,2])=="trias środkowy" & pull(type4_ready[row,col])%in%unique(pull(filter(type4, ODDZIAL=="trias środkowy"),true_))) index_poprawny <- append(index_poprawny, col)
    ...
    if(pull(type4_ready[row,2])=="dewon górny" & pull(type4_ready[row,col])%in%unique(pull(filter(type4, ODDZIAL=="dewon górny"),true_))) index_poprawny <- append(index_poprawny, col)
    
    if(pull(type4_ready[row,2])=="dewon środkowy" & pull(type4_ready[row,col])%in%unique(pull(filter(type4, ODDZIAL=="dewon środkowy"),true_))) index_poprawny <- append(index_poprawny, col)
    ...
    if(pull(type4_ready[row,2])=="ordowik górny" & pull(type4_ready[row,col])%in%unique(pull(filter(type4, ODDZIAL=="ordowik górny"),true_))) index_poprawny <- append(index_poprawny, col)
    
    if(pull(type4_ready[row,2])=="ordowik środkowy" & pull(type4_ready[row,col])%in%unique(pull(filter(type4, ODDZIAL=="ordowik środkowy"),true_))) index_poprawny <- append(index_poprawny, col)
